  ...
  return {
    async setup() {
      await store.integrations.insert({
        ...
        connected: true,
        last_sync_at: opts.lastSyncDaysAgo != null ? daysAgo(opts.lastSyncDaysAgo) : daysAgo(0.5),
        last_dashboard_access: opts.lastAccessDaysAgo != null ? daysAgo(opts.lastAccessDaysAgo) : daysAgo(0.2),
        created_at: opts.createdDaysAgo != null ? daysAgo(opts.createdDaysAgo) : daysAgo(60),
      });
      ...
      if (opts.plan && opts.plan !== "starter") {
        await store.subscriptions.insert({
          ...
          current_period_end: opts.renewalDaysAhead != null ? daysAgo(-opts.renewalDaysAhead) : null,
        });
      }
