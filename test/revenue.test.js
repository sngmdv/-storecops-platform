...
async function seedStore(store, opts = {},) {
  ...
  if (opts.plan && opts.plan !== 'starter') {
    await store.subscriptions.insert({
      ...
      current_period_end: opts.renewalDaysAhead !== null && opts.renewalDaysAhead !== undefined ? daysAhead(opts.renewalDaysAhead,) : null,
      cancelled_at: opts.churnedDaysAgo !== null && opts.churnedDaysAgo !== undefined ? daysAgo(opts.churnedDaysAgo,) : null,
    },);
  }
